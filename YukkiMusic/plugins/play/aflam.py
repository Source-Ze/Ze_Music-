...
async def AFYONA1(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE1 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE2 " + str(m.from_user.id))],
...
async def AFYONA2(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE3 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE4 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA3(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE5 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE6 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA4(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE7 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE8 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA5(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE9 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE10 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA6(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE11 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE12 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA7(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE13 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE14 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA8(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE15 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE16 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA9(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE17 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE18 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA10(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE19 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE20 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA11(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE21 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE22 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA12(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE23 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE24 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA13(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE25 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE26 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA14(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE27 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE28 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA15(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE29 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE30 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA16(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE31 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE32 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA17(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE33 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE34 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA18(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE35 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE36 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA19(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE37 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE38 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
async def AFYONA20(c: Client, m: CallbackQuery):
    ...
    if m.from_user.id != int(a[1]):
        ...
        return
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("⌯ جوده متوسطه", callback_data="ZE39 " + str(m.from_user.id))] +
        [InlineKeyboardButton("⌯ جوده عاليه", callback_data="ZE40 " + str(m.from_user.id))],
        [InlineKeyboardButton("◁", callback_data="comedy " + str(m.from_user.id))],
    ])
...
@app.on_callback_query(filters.regex("^ZE1 (\\d+)$"))
async def ZE1(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE2 (\\d+)$"))
async def ZE2(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE3 (\\d+)$"))
async def ZE3(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE4 (\\d+)$"))
async def ZE4(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE5 (\\d+)$"))
async def ZE5(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE6 (\\d+)$"))
async def ZE6(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE7 (\\d+)$"))
async def ZE7(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE8 (\\d+)$"))
async def ZE8(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE9 (\\d+)$"))
async def ZE9(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE10 (\\d+)$"))
async def ZE10(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE11 (\\d+)$"))
async def ZE11(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE12 (\\d+)$"))
async def ZE12(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE13 (\\d+)$"))
async def ZE13(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE14 (\\d+)$"))
async def ZE14(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE15 (\\d+)$"))
async def ZE15(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE16 (\\d+)$"))
async def ZE16(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE17 (\\d+)$"))
async def ZE17(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE18 (\\d+)$"))
async def ZE18(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE19 (\\d+)$"))
async def ZE19(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE20 (\\d+)$"))
async def ZE20(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE21 (\\d+)$"))
async def ZE21(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE22 (\\d+)$"))
async def ZE22(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE23 (\\d+)$"))
async def ZE23(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE24 (\\d+)$"))
async def ZE24(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE25 (\\d+)$"))
async def ZE25(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE26 (\\d+)$"))
async def ZE26(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE27 (\\d+)$"))
async def ZE27(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE28 (\\d+)$"))
async def ZE28(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE29 (\\d+)$"))
async def ZE29(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE30 (\\d+)$"))
async def ZE30(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE31 (\\d+)$"))
async def ZE31(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE32 (\\d+)$"))
async def ZE32(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE33 (\\d+)$"))
async def ZE33(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE34 (\\d+)$"))
async def ZE34(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE35 (\\d+)$"))
async def ZE35(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE36 (\\d+)$"))
async def ZE36(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE37 (\\d+)$"))
async def ZE37(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE38 (\\d+)$"))
async def ZE38(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE39 (\\d+)$"))
async def ZE39(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
...
@app.on_callback_query(filters.regex("^ZE40 (\\d+)$"))
async def ZE40(c: Client, m: CallbackQuery):
    a = m.data.split(" ")
    if m.from_user.id != int(a[1]):
        await c.answer_callback_query(m.id, text="صاحب الامر هو فقط من يستطيع الضغط على الزر 🐉", show_alert=True)
        return
