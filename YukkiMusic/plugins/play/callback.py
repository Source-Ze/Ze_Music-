...
\n __ Developer by [ᖴ᥆ᖇ mody. 🐉](https://t.me/UP_UO)""",
        reply_markup=InlineKeyboardMarkup(
    ...
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("البوت", url=f"https://t.me/S1CXBOT"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/UP_UO"),
                ],
                [InlineKeyboardButton("ᖴ᥆ᖇ mody. 🐉", url=f"https://t.me/UP_UO")],
            ]
        ),
    )
